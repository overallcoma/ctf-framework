...
flagpagename += ".php"
passwordpage = ''.join([random.choice(string.ascii_letters + string.digits) for n in range(64)])
passwordpage += ".php"
...
passwordpagephp = """{0}""".format(password)
...
file.close()
file = open(passwordpage, 'w+')
file.write(passwordpage)
file.close()
